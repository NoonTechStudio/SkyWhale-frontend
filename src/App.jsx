...
function App() {
  ...
  <Routes>
    ...
    <Route path="/preview/aura" element={<AuraTemplate clientData={sampleClient} />} />
    <Route path="/preview/vertex" element={<VertexTemplate clientData={sampleClient} />} />
    <Route path="/preview/nexus" element={<NexusTemplate clientData={sampleClient} />} />
    
    {/* Redirects */}
    <Route path="/hakunamatata" element={<Navigate to="/admin-login" replace />} />
